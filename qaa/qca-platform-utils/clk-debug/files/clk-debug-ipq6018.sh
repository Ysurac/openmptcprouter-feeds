...
GCC_MEM_NOC_UBI32_CBCR=0x0181D03C
GCC_DDRSS_ATB_CBCR=0x0181D040
GCC_MEM_NOC_LPASS_CBCR=0x0181D044
GCC_MEM_NOC_APSS_TCU_CBCR=0x0181D048
GCC_LPASS_Q6_AXIM_CBCR=0x0181F010
GCC_LPASS_Q6SS_TSCTR_1TO2_CBCR=0x0181F014
GCC_LPASS_Q6_ATBM_AT_CBCR=0x0181F018
GCC_LPASS_Q6_PCLKDBG_CBCR=0x0181F01C
GCC_LPASS_CORE_AXIM_CBCR=0x0181F028
GCC_LPASS_Q6SS_TRIG_CBCR=0x0181F038
GCC_LPASS_SNOC_CFG_CBCR=0x0181F048
...
GCC_UBI0_UTCM_CBCR=0x0182606C
GCC_SNOC_NSSNOC_CBCR=0x01826070
GCC_SNOC_LPASS_CFG_CBCR=0x01826074
GCC_PCNOC_AHB_CBCR=0x0182701C
GCC_PCNOC_LPASS_CBCR=0x01827020
...
GCC_SNOC_BUS_TIMEOUT1_AHB_CBCR=0x0184700C
GCC_SNOC_BUS_TIMEOUT2_AHB_CBCR=0x01847014
...
calculate_clk GCC_SNOC_NSSNOC_CLK 5
calculate_clk GCC_SYS_NOC_AT_CLK 6
calculate_clk GCC_PCNOC_AHB_CLK 8
calculate_clk GCC_PCNOC_LPASS_CLK 9
...
calculate_clk GCC_MEM_NOC_LPASS_CLK 25
...
calculate_clk GCC_SNOC_LPASS_CFG_CLK 31
...
calculate_clk GCC_LPASS_Q6_AXIM_CLK 48
calculate_clk GCC_LPASS_Q6SS_TRIG_CLK 49
calculate_clk GCC_LPASS_Q6_ATBM_AT_CLK 50
calculate_clk GCC_LPASS_Q6_PCLKDBG_CLK 51
calculate_clk GCC_LPASS_CORE_AXIM_CLK 52
calculate_clk GCC_LPASS_Q6SS_TSCTR_1TO2_CLK 54
...
calculate_clk GCC_TIC_PCNOC_CLK 60
...
calculate_clk GCC_UBI32_TBU_CLK 85
...
calculate_clk GCC_LPASS_TBU_CLK 92
...
calculate_clk GCC_MEM_NOC_UBI32_CLK 339
...
calculate_clk GCC_SNOC_BUS_TIMEOUT1_AHB_CLK 369
calculate_clk GCC_SNOC_BUS_TIMEOUT2_AHB_CLK 370
...
calculate_clk GCC_LPASS_SNOC_CFG_CLK 424
